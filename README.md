...
- **也能直接当浏览器用**:内置网页模式(带地址栏),看网页视频不用先下载(见下文)
...
| 操作 | 怎么做 |
|---|---|
| 切进 / 切出 | `Ctrl+Alt+B`,或设置里选「浏览器」/「本地视频」 |
...
| 快退 | `Ctrl+Alt+Left` |
| 快进 | `Ctrl+Alt+Right` |
| 显示 / 隐藏播放窗口 | `Ctrl+Alt+T` |
| 视频 / 网页模式切换 | `Ctrl+Alt+B` |
...
- 网页模式下:
  - 画面顶部的拖动条会占掉网页最上面那 20 来像素,那一条里的网页内容点不到(正常情况下那一片是网站的空白/标题区);
